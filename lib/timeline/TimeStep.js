...
class TimeStep {
  ...
  setMinimumStep(minimumStep) {
    ...
    if(this.options.showWeekScale) {
      ...
      if (stepDay*2 > minimumStep)          {this.scale = 'week';      this.step = 1;}
      if (stepDay > minimumStep)            {this.scale = 'week';      this.step = 1;}
    } else {
      if (stepDay*7 > minimumStep)          {this.scale = 'day';       this.step = 1;}
      if (stepDay*2 > minimumStep)          {this.scale = 'day';       this.step = 1;}
